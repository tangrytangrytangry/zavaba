...
zbResetValidator.prototype.validatePassword = function(s)
{
	if (s.length >= 6){
		return true;
	}	else{
...
zbResetValidator.prototype.showAlert = function(m)
{
...
zbResetValidator.prototype.hideAlert = function()
{
	this.setPasswordAlert.hide();
}

zbResetValidator.prototype.showSuccess = function(m)
{
